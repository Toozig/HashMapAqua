...
///// file name: SpamDetector.cpp                           ///
/////Description: This file contains the main               ///
/////                function of the SpamDetector program   ///
///////////////////////////////////////////////////////////////
//
//
///////////////////// includes ///////////////////
...
//
///**
// * Static class with function to parse Mail and database files.
// */
//class Parser
//{
//
...
//public:
//    /**
//     * Ctor of the parser class is deleted since this is a static class
//     */
//    Parser() = delete;
//
//
...
//        {
//
//            // checks if there are more than 2 ',' and if vaild
...
// */
//size_t phraseCounter(const std::string& mail, const std::string& phrase)
//    {
